...
const Navbar = () => {
    ...
    const navLinks = (
        ...
        whileTap={{scale:0.9}}  onClick={(e) => {
            e.preventDefault()
            handleCloseMenu()
            handleScrollTo('services') }} className={`text-white ${activeSection === 'services' ? 'isActive' : ''}`}>Services</motion.a>
        </li>
        <li>
        <motion.a href="#about"
        whileHover={{scale:1.1}}
        ...
        }} className={`text-white ${activeSection === 'testimonial' ? 'isActive' : ''}`}>Testimonials</motion.a>
        </li>
        </ul>
    )
  return (
