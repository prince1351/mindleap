...
const Testimonials = () => {
  return (
    <div id="testimonial" className="bg-[#f7f8fc] pt-16">
            <div className="container mx-auto px-8 pb-20">
            <div className="text-center mb-12">
          <h2 className="text-4xl font-bold font-secondary mb-3">What Our Clients Say</h2>
          <p className="text-lg mb-12 md:w-4/5 mx-auto">Hear from some of our satisfied cliends about how our services have positively impacted their lives and well-being</p>
        </div>
                 ...
                 testimonials.map((testimonial, index) => (
                  <div key={index} className="relative bg-white rounded-lg p-6 flex-1">
                    ...
                    <div className="flex flex-col space-y-3 mb-4">
                      <p className="text-base mb-2">{testimonial.review}</p>
